...
<nav class="pf-nav">
    ...
    <div class="pf-nav__desplegable">
	  ...
	  <ol class="breadcrumb">
	    <li class="breadcrumb-item" aria-current="page"><a href="inicio">Inicio</a></li>
	     <li class="breadcrumb-item" aria-current="page"><a href="inicio">Pedido realizado</a></li>
	  </ol>
	</nav>
	...
	<section class="pf-carrito">
				 ...
				 <h2 class="pf-carrito__title">Pedido realizado</h2>

            
		          <div class="pf-carrito__container--nocontent">
		            <p>Actualmente se ha realizado el pedido correctamente.</p>
